...
public class coinChange {
	...
	public static int greedyCoin(int argNumber){
	...
	public static int dynamicCoin(int argNumber){
	...
	public static void main(String[] args) {
		...
		while(dynamicBetter!=1){
			...
			int greedyResult = greedyCoin(someNum);
			int dynamicResult = dynamicCoin(someNum);
